...
public class RecapConstants {
    ...
    public static final String MATCHING_ALGO_Q = "seda:matchingAlgoQ";
    public static final String CSV_MATCHING_ALGO_REPORT_Q = "seda:csvMatchingAlgoReportQ";
    public static final String CSV_EXCEPTION_REPORT_Q = "seda:csvExceptionReportQ";
    public static final String FTP_MATCHING_ALGO_REPORT_Q = "seda:ftpMatchingAlgoReportQ";
    public static final String FTP_EXCEPTION_REPORT_Q = "seda:ftpExceptionReportQ";

    public static final String MATCHING_ALGO_ROUTE_ID = "matchingAlgoRoute";
    public static final String CSV_MATCHING_ALGO_REPORT_ROUTE_ID = "csvMatchingAlgoReportRoute";
    public static final String CSV_EXCEPTION_REPORT_ROUTE_ID = "csvExceptionReportRoute";
    public static final String FTP_MATCHING_ALGO_REPORT_ROUTE_ID = "ftpMatchingAlgoReportRoute";
    public static final String FTP_EXCEPTION_REPORT_ROUTE_ID = "ftpExceptionReportRoute";

    public static final String MATCHING_ALGO_FULL_FILE_NAME = "Matching_Algo_Phase_1";
    ...
    public static final String MATCH_POINT_TAG = "MatchingPointTag";

    public static final String MATCH_POINT_CONTENT = "MatchPointContent";
    public static final String OCLC_TAG = "035";
    public static final String ISBN_TAG = "020";
    public static final String ISSN_TAG = "022";

    public static final String LCCNN_TAG = "010";
