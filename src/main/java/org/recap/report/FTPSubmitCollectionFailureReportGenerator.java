 ...
 */
@Component
public class FTPSubmitCollectionFailureReportGenerator implements ReportGeneratorInterface {
    ...
    public String generateReport(String fileName, List<ReportEntity> reportEntityList) {
        ...
        producerTemplate.sendBodyAndHeader(RecapConstants.FTP_SUBMIT_COLLECTION_FAILURE_REPORT_Q, submitCollectionReportRecordList, "fileName", fileName);
