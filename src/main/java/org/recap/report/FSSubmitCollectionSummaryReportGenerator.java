 ...
 */
@Component
public class FSSubmitCollectionSummaryReportGenerator implements ReportGeneratorInterface {
    ...
    public String generateReport(String fileName, List<ReportEntity> reportEntityList) {
        ...
        producerTemplate.sendBodyAndHeader(RecapConstants.FS_SUBMIT_COLLECTION_SUMMARY_REPORT_Q, submitCollectionReportRecordList, "fileName", fileName);
