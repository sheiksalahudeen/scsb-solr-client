 ...
 */
@Component
public class FSSubmitCollectionFailureReportGenerator implements ReportGeneratorInterface {
    ...
    public String generateReport(String fileName, List<ReportEntity> reportEntityList) {
        ...
        producerTemplate.sendBodyAndHeader(RecapConstants.FS_SUBMIT_COLLECTION_FAILURE_REPORT_Q, submitCollectionReportRecordList, "fileName", fileName);
