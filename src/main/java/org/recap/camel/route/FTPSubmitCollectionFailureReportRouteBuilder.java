 ...
 */
@Component
public class FTPSubmitCollectionFailureReportRouteBuilder {

    private static final Logger logger = LoggerFactory.getLogger(FTPSubmitCollectionFailureReportRouteBuilder.class);
