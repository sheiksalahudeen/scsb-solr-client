 ...
 */
@Component
public class FSSubmitCollectionRejectionRouteBuilder {

    @Autowired
    public FSSubmitCollectionRejectionRouteBuilder(CamelContext context, @Value("${submit.collection.report.directory}") String reportsDirectory) {
        try {
