...
@Component
public class FTPMatchingReportGenerator implements ReportGeneratorInterface {
    ...
    public String generateReport(String fileName, String type, Date from, Date to) {
        ...
        if(!CollectionUtils.isEmpty(matchingReportReCAPCSVRecords)) {
            ...
            producer.sendBodyAndHeader(RecapConstants.FTP_MATCHING_ALGO_REPORT_Q, reCAPCSVMatchingRecord, RecapConstants.REPORT_FILE_NAME, fileName);
