 ...
 */
public class HoldRequestItemDetailsRepositoryUT extends BaseTestCase {
    ...
    public void checkSaveForItemEntity() throws Exception {
        ...
        itemEntity1.setOwningInstitutionItemId("t11");
        itemEntity1.setDeleted(false);

        itemEntityList.add(itemEntity1);

        ItemEntity itemEntity2 = new ItemEntity();
        itemEntity2.setBarcode("b12");
        ...
        itemEntity2.setOwningInstitutionItemId("t12");
    ...
    public void checkSaveForRequestEntity() throws Exception {
        ...
        requestItemEntity1.setItemId(81);
        ...
        requestItemEntity2.setItemId(80);
    ...
    @Test
    public void checkGetHoldRequestCountsForPul() throws Exception{
        ...
        long count = requestItemDetailsRepository.getBDHoldRecallRetrievalRequestCounts(fromDate,toDate,1,1);
        assertNotNull(count);
        assertEquals(2,count);
    }

    @Test
    public void checkGetHoldRequestCountsForCul() throws Exception{
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date fromDate = simpleDateFormat.parse("2016-11-01 00:00:00");
        Date toDate = simpleDateFormat.parse("2016-12-20 23:59:59");
        long count = requestItemDetailsRepository.getBDHoldRecallRetrievalRequestCounts(fromDate,toDate,2,1);
        assertNotNull(count);
        assertEquals(4,count);
    }

    @Test
    public void checkGetHoldRequestCountsForNypl() throws Exception{
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date fromDate = simpleDateFormat.parse("2016-11-01 00:00:00");
        Date toDate = simpleDateFormat.parse("2016-12-20 23:59:59");
        long count = requestItemDetailsRepository.getBDHoldRecallRetrievalRequestCounts(fromDate,toDate,3,1);
        assertNotNull(count);
