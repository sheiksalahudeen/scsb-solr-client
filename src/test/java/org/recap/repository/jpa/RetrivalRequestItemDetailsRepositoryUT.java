 ...
 */
public class RetrivalRequestItemDetailsRepositoryUT extends BaseTestCase {
    ...
    public void checkSaveForItemEntity() throws Exception {
        ...
        itemEntity1.setOwningInstitutionItemId("t9");
        itemEntity1.setDeleted(false);

        itemEntityList.add(itemEntity1);

        ItemEntity itemEntity2 = new ItemEntity();
        itemEntity2.setBarcode("b10");
        ...
        itemEntity2.setOwningInstitutionItemId("t10");
    ...
    public void checkSaveForRequestEntity() throws Exception {
        ...
        requestItemEntity1.setItemId(85);
        ...
        requestItemEntity2.setItemId(84);
